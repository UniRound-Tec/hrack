...
> 状态：**独立参考实现与本地真实接口验收已完成（2026-08-20）**。对应 [SPEC-REMOTE.md](./SPEC-REMOTE.md) §6、§8、§11 P2。公网部署和 HRack P3 联调仍未开始。
>
...
仍不宣称：公网/公网 CA 证书生命周期、外部网络延迟、20,000 连接容量、多副本、真实 HRack P3 联调。`MAX_CONNECTIONS=20,000` 继续只是安全上限。
