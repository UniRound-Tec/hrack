...
export const zhCN = {
  ...
  dsh: {
    ...
    retentionDays: '按天数',
    retentionCount: '按数量',
    settingsHint: '运行时、凭据、模型与预设都在这里改，不再打开官方设置层。',
    runtimeSection: '运行时',
    credentialsSection: '凭据',
    presetsSection: 'Agent 预设',
    modelsSection: '模型',
    hostSection: 'Host 配置',
    apiKey: 'API 密钥',
    apiKeyHint: '配置官方模型即可开始使用。',
    apiKeyPlaceholder: '输入 API 密钥',
    apiKeyConfigured: '已配置',
    save: '保存',
    emptyPresets: '还没有 Agent 预设',
    defaultPreset: '默认',
    emptyModels: '选择器里还没有模型。',
    openDocument: '打开配置文件',
    openDocumentHint: '用系统编辑器打开 host 的 settings 文档。',
    appliesLive: '立即生效',
    appliesRestart: '需重启 host',
    secretSlots: (count: number) => `${count} 个密钥槽`,
    navGeneral: '通用设置',
    navModels: '模型',
    navPlugins: '插件',
    navPresets: 'Agent 预设',
