...
export const ko = {
  ...
  dsh: {
    ...
    retentionDays: '일 수',
    retentionCount: '개수',
    settingsHint: '런타임, 자격 증명, 모델, 프리셋은 여기에서 바꿉니다. 공식 오버레이는 쓰지 않습니다.',
    runtimeSection: '런타임',
    credentialsSection: '자격 증명',
    presetsSection: 'Agent 프리셋',
    modelsSection: '모델',
    hostSection: 'Host 설정',
    apiKey: 'API 키',
    apiKeyHint: '공식 모델을 쓰려면 키를 넣으세요.',
    apiKeyPlaceholder: 'API 키 입력',
    apiKeyConfigured: '설정됨',
    save: '저장',
    emptyPresets: '아직 Agent 프리셋이 없습니다',
    defaultPreset: '기본',
    emptyModels: '선택기에 모델이 없습니다.',
    openDocument: '설정 파일 열기',
    openDocumentHint: '시스템 편집기로 host settings 문서를 엽니다.',
    appliesLive: '즉시 적용',
    appliesRestart: 'host 재시작 필요',
    secretSlots: (count: number) => `비밀 슬롯 ${count}개`,
    navGeneral: '일반',
    navModels: '모델',
    navPlugins: '플러그인',
