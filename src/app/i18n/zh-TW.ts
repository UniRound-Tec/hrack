...
export const zhTW = {
  ...
  dsh: {
    ...
    retentionDays: '依天數',
    retentionCount: '依數量',
    settingsHint: '執行環境、憑證、模型與預設都在這裡改，不再打開官方設定層。',
    runtimeSection: '執行環境',
    credentialsSection: '憑證',
    presetsSection: 'Agent 預設',
    modelsSection: '模型',
    hostSection: 'Host 設定',
    apiKey: 'API 金鑰',
    apiKeyHint: '設定官方模型即可開始使用。',
    apiKeyPlaceholder: '輸入 API 金鑰',
    apiKeyConfigured: '已設定',
    save: '儲存',
    emptyPresets: '還沒有 Agent 預設',
    defaultPreset: '預設',
    emptyModels: '選擇器裡還沒有模型。',
    openDocument: '開啟設定檔',
    openDocumentHint: '用系統編輯器開啟 host 的 settings 文件。',
    appliesLive: '立即生效',
    appliesRestart: '需重啟 host',
    secretSlots: (count: number) => `${count} 個密鑰槽`,
    navGeneral: '一般設定',
    navModels: '模型',
    navPlugins: '外掛',
    navPresets: 'Agent 預設',
