...
export const en = {
  ...
  settings: {
    ...
    themeJsonHint: 'Edit the fixed custom.json; pick it from the theme selector after saving',
    themeJsonReset: 'Discard JSON changes',
    themeJsonSave: 'Save theme',
    themeJsonSaving: 'Saving…',
    themeJsonSaved: 'Theme saved and applied',
    themeJsonInvalid: 'Invalid JSON',
    ...
    floatingRendererSkillCopied: 'Copied',
    floatingScale: 'Floating window size',
    floatingScaleHint: 'Uniformly scales built-in and custom renderers and remembers the size',
    floatingAttentionEffect: 'Attention effects',
    floatingAttentionEffectHint: 'Flash for approval requests, completion, and errors; can be disabled',
    floatingRendererErrors: 'User floating renderer load failures',
    ...
    terminalBackgroundPreview: 'Background preview',
    terminalBackgroundFit: 'Image fit',
    terminalBackgroundFitHint: 'Cover crops, contain letterboxes, stretch may distort, tile repeats',
    terminalBackgroundFitCover: 'Cover',
    terminalBackgroundFitContain: 'Contain',
    terminalBackgroundFitFill: 'Stretch',
    terminalBackgroundFitTile: 'Tile',
    ...
    updateCurrentVersion: (version: string) => `Current version: ${version}`,
    updateLoading: 'Loading update status…',
    updateDisabled: 'Development builds do not connect to the update service',
    updateIdle: 'Automatic updates are enabled',
    updateChecking: 'Checking GitHub Releases…',
    updateAvailable: (version: string) => `Version ${version} found; preparing download`,
    updateDownloading: (version: string, percent: number) =>
      `Downloading ${version} · ${percent}%`,
    updateDownloaded: (version: string) => `${version} is ready to install`,
    updateUpToDate: 'You are up to date',
    updateError: (error: string) => `Update failed: ${error || 'Unknown error'}`,
