...
export const en = {
  ...
  dsh: {
    ...
    settingsHint: 'Runtime, credentials, models, and presets live here — not in the official overlay.',
    runtimeSection: 'Runtime',
    credentialsSection: 'Credentials',
    presetsSection: 'Agent presets',
    modelsSection: 'Models',
    hostSection: 'Host config',
    apiKey: 'API key',
    apiKeyHint: 'Add a key to start using official models.',
    apiKeyPlaceholder: 'Enter your API key',
    apiKeyConfigured: 'Configured',
    save: 'Save',
    emptyPresets: 'No agent presets yet',
    defaultPreset: 'Default',
    emptyModels: 'No models will be shown in the selector.',
    openDocument: 'Open config file',
    openDocumentHint: 'Open the host settings document in a system editor.',
    appliesLive: 'Applies live',
    appliesRestart: 'Needs host restart',
    secretSlots: (count: number) => `${count} secret slots`,
    navGeneral: 'General',
    navModels: 'Models',
    navPlugins: 'Plugins',
