...
export const ja = {
  ...
  dsh: {
    ...
    retentionDays: '日数',
    retentionCount: '件数',
    settingsHint: 'ランタイム・認証・モデル・プリセットはここで変更します。公式オーバーレイは使いません。',
    runtimeSection: 'ランタイム',
    credentialsSection: '認証',
    presetsSection: 'Agent プリセット',
    modelsSection: 'モデル',
    hostSection: 'Host 設定',
    apiKey: 'API キー',
    apiKeyHint: '公式モデルを使うためのキーです。',
    apiKeyPlaceholder: 'API キーを入力',
    apiKeyConfigured: '設定済み',
    save: '保存',
    emptyPresets: 'Agent プリセットはまだありません',
    defaultPreset: 'デフォルト',
    emptyModels: 'セレクタにモデルがありません。',
    openDocument: '設定ファイルを開く',
    openDocumentHint: 'システムのエディタで host の settings を開きます。',
    appliesLive: '即時反映',
    appliesRestart: 'host の再起動が必要',
    secretSlots: (count: number) => `シークレット ${count} 件`,
    navGeneral: '一般',
    navModels: 'モデル',
    navPlugins: 'プラグイン',
